...
default['windows_slave']['pickles']              = 'https://github.com/picklesdoc/pickles/releases/download/v0.18.2/Pickles-0.18.2.zip'
...
default['windows_slave']['resharper']            = 'http://download-cf.jetbrains.com/resharper/jb-commandline-8.2.1000.4527.zip'
